            ...
            {(showFullLog ? allBackups : allBackups.slice(0, 5)).map((backup) => (
              <div key={backup.id}>
                <div
                  ...
                  className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-900/50 rounded-lg mb-4 border border-gray-200 dark:border-gray-700 transition-colors cursor-pointer"
                >
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2">
                          {Object.entries(backup.tables_backed_up)
                            ...
                            .map(([table, count]) => (
                              <div
                                key={table}
                                className="flex justify-between items-center p-2 bg-gray-50 dark:bg-gray-900/50 rounded text-xs border border-gray-200 dark:border-gray-700"
                              >
